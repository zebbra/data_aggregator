defmodule Pagify.ValidationTest do
  ...
  test "passes with empty params and resource" do
    assert {:ok, %Pagify{limit: 15, offset: 0, scopes: %{status: :all}}} ==
  ...
  test "detects all errors and validates params" do
    ...
    assert [
             ...
             filter_form: [%Pagify.Error.Query.InvalidFilterFormParameter{filter_form: -1}],
             scopes: [%Pagify.Error.Query.InvalidScopesParameter{scopes: -1}],
             search: [%Pagify.Error.Query.InvalidSearchParameter{search: -1}]
           ] = errors
  ...
  describe "validate_scopes/2" do
    ...
    test "replaces invalid scope group and adds errors" do
      ...
      assert %{
               ...
               Validation.validate_scopes(%{scopes: %{invalid: :admin}}, pagify_scopes, nil,
                 replace_invalid_params?: true
               )
    end
    ...
    test "replaces invalid scopes parameter" do
      ...
      assert %{
               ...
               Validation.validate_scopes(%{scopes: 1}, pagify_scopes, nil, replace_invalid_params?: true)
    end
