  ...
  describe "DataAggregator.Records.update_mapping/1" do
    ...
    test "with valid file", %{import: import} do
      ...
      assert columns == [
               ...
               {"DAYCOLLECTED", :string, nil},
               {"MONTHCOLLECTED", :string, nil},
               {"YEARCOLLECTED", :string, nil},
               {"ENDOFPERIODDAY", :string, nil},
               {"ENDOFPERIODMONTH", :string, nil},
               {"ENDOFPERIODYEAR", :string, nil},
