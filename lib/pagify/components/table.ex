defmodule Pagify.Components.Table do
  @moduledoc false
  ...
  defp header_column(%{sortable: true} = assigns) do
    direction = order_direction(assigns.meta.pagify, assigns.field)
  ...
  defp order_direction(%Pagify{order_by: [{field, direction} | _]}, field), do: direction
  defp order_direction(_pagify, _field), do: nil
