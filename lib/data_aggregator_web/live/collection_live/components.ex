defmodule DataAggregatorWeb.CollectionLive.Components do
  ...
  def scope_stat(assigns) do
    ...
    <.link
      patch={@href}
      class={[
        "stat max-lg:px-3 max-lg:py-1.5 max-lg:text-sm rounded-md",
        @active && "text-neutral-content bg-neutral",
        @active == false && "hover:bg-base-content/10 border-black-white/10 border"
      ]}
    >
