defmodule DataAggregatorWeb.CollectionLive.ImageUpload.Subscriptions do
  ...
  @image_upload_update_events ~w(set_extracting set_extracted set_extraction_failed set_mapping set_mapped set_mapping_incomplete set_mapping_failed add_mapping_progress)
