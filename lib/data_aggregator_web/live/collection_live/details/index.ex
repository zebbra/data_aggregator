defmodule DataAggregatorWeb.CollectionLive.Details.Index do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    <.page current="collections">
      <.collection_header collection={@collection} current={:details} />
    </.page>
    """
  end

  defp apply_action(socket, :index, _params) do
    assign(socket, :page_title, ~t"Collection Details"m)
  end
end
