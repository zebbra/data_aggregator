defmodule DataAggregatorWeb.Components.Loading do
  @moduledoc """
  Renders a spinner with generic tailwindui styling.
  """
  ...
  defp get_spinner_classes(user_added_classes, show, size, custom_size_class) do
    ...
    ["animate-spin", !show && "hidden", size_classes, user_added_classes]
  end
end
