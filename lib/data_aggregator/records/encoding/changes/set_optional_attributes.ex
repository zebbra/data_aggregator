defmodule DataAggregator.Records.Encoding.Changes.SetOptionalAttributes do
  @moduledoc """
  Set optional fields for a encoded_record according to its provided record. We mirror the record data on the raw layer to the encoded_record for convenience reasons.
  This way we can easily access the record data from the encoded_record. During encoding we overwrite all attributes which come back from the catalogs
  """
